...
public class BlockMinedTaskType implements ITaskType, IItemStacksProvider{
	private static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(Constants.MODID, "block_mined");
	private static final Component TRANSLATION = Component.translatable(Constants.MODID + ".standardcontent.tasks.block_mined");
