		...
		if(json.has("dimension")){
			...
			if(jsonElement.isJsonPrimitive()){
				...
				if(jsonPrimitive.isString()){
					...
					if(dimension == null){
						CustomQuestsLogger.warn("'Quest > " + questId + " > tasks > entries > " + taskId + " > sub_tasks > entries > " + subtaskId + " > dimension': Value is not a valid dimension, please use a valid dimension id, defaulting to 'minecraft:overworld'!");
						dimension = BuiltinDimensionTypes.OVERWORLD.location();
					}
				}else{
					CustomQuestsLogger.warn("'Quest > " + questId + " > tasks > entries > " + taskId + " > sub_tasks > entries > " + subtaskId + " > dimension': Value is not a String, defaulting to 'minecraft:overworld'!");
					dimension = BuiltinDimensionTypes.OVERWORLD.location();
				}
			}else{
				CustomQuestsLogger.warn("'Quest > " + questId + " > tasks > entries > " + taskId + " > sub_tasks > entries > " + subtaskId + " > dimension': Value is not a JsonPrimitive, please use a String, defaulting to 'minecraft:overworld'!");
				dimension = BuiltinDimensionTypes.OVERWORLD.location();
			}
		}else{
			CustomQuestsLogger.warn("'Quest > " + questId + " > tasks > entries > " + taskId + " > sub_tasks > entries > " + subtaskId + " > dimension': Not detected, defaulting to 'minecraft:overworld'!");
			dimension = BuiltinDimensionTypes.OVERWORLD.location();
		}
		...
		if(json.has("x")){
			...
			if(jsonElement.isJsonPrimitive()){
				...
				if(jsonPrimitive.isNumber()){
					...
					CustomQuestsLogger.warn("'Quest > " + questId + " > tasks > entries > " + taskId + " > sub_tasks > entries > " + subtaskId + " > x': Value is not an Integer, defaulting to '0'!");
					x = 0;
				}
			}else{
				CustomQuestsLogger.warn("'Quest > " + questId + " > tasks > entries > " + taskId + " > sub_tasks > entries > " + subtaskId + " > x': Value is not a JsonPrimitive, please use a Double, defaulting to '0'!");
				x = 0;
			}
		}else{
			CustomQuestsLogger.warn("'Quest > " + questId + " > tasks > entries > " + taskId + " > sub_tasks > entries > " + subtaskId + " > x': Not detected, defaulting to '0'!");
			x = 0;
		}
		...
		if(json.has("y")){
			...
			if(jsonElement.isJsonPrimitive()){
				...
				if(jsonPrimitive.isNumber()){
					...
					CustomQuestsLogger.warn("'Quest > " + questId + " > tasks > entries > " + taskId + " > sub_tasks > entries > " + subtaskId + " > y': Value is not an Integer, defaulting to '0'!");
					y = 0;
				}
			}else{
				CustomQuestsLogger.warn("'Quest > " + questId + " > tasks > entries > " + taskId + " > sub_tasks > entries > " + subtaskId + " > y': Value is not a JsonPrimitive, please use a Double, defaulting to '0'!");
				y = 0;
			}
		}else{
			CustomQuestsLogger.warn("'Quest > " + questId + " > tasks > entries > " + taskId + " > sub_tasks > entries > " + subtaskId + " > y': Not detected, defaulting to '0'!");
			y = 0;
		}
		...
		if(json.has("z")){
			...
			if(jsonElement.isJsonPrimitive()){
				...
				if(jsonPrimitive.isNumber()){
					...
					CustomQuestsLogger.warn("'Quest > " + questId + " > tasks > entries > " + taskId + " > sub_tasks > entries > " + subtaskId + " > z': Value is not an Integer, defaulting to '0'!");
					z = 0;
				}
			}else{
				CustomQuestsLogger.warn("'Quest > " + questId + " > tasks > entries > " + taskId + " > sub_tasks > entries > " + subtaskId + " > z': Value is not a JsonPrimitive, please use a Double, defaulting to '0'!");
				z = 0;
			}
		}else{
			CustomQuestsLogger.warn("'Quest > " + questId + " > tasks > entries > " + taskId + " > sub_tasks > entries > " + subtaskId + " > z': Not detected, defaulting to '0'!");
			z = 0;
		}
		...
		if(json.has("range")){
			...
			if(jsonElement.isJsonPrimitive()){
				...
				if(jsonPrimitive.isNumber()){
					...
					CustomQuestsLogger.warn("'Quest > " + questId + " > tasks > entries > " + taskId + " > sub_tasks > entries > " + subtaskId + " > range': Value is not an Integer, defaulting to '-1'!");
					range = -1;
				}
			}else{
				CustomQuestsLogger.warn("'Quest > " + questId + " > tasks > entries > " + taskId + " > sub_tasks > entries > " + subtaskId + " > range': Value is not a JsonPrimitive, please use a Double, defaulting to '-1'!");
				range = -1;
			}
		}else{
			CustomQuestsLogger.warn("'Quest > " + questId + " > tasks > entries > " + taskId + " > sub_tasks > entries > " + subtaskId + " > range': Not detected, defaulting to '-1'!");
			range = -1;
		}
	}
