...
public class GLScissorStack{
    ...
    public static void push(GuiGraphics matrixStack, int x, int y, int width, int height){
        if(!STACK.isEmpty()){
    ...
    public static void pop(GuiGraphics matrixStack){
    ...
    private static class StackEntry{
        ...
        public void enable(GuiGraphics matrixStack, Quadruple<Integer, Integer, Integer, Integer> area){
            GLScissor.enable(matrixStack, area.getFirst(), area.getSecond(), area.getThird(), area.getFourth());
        }
        
        public void disable(GuiGraphics matrixStack){
