	...
	public void processJson(JsonObject json){
		if(json.has("sub_rewards")){
			...
			if(jsonElement.isJsonObject()){
				...
				CustomQuestsLogger.warn("'Quest > " + parentQuestId + " > rewards > entries > " + rewardId + " > sub_rewards': Value is not a JsonObject, generating a new one!");
				subRewards.processJson(new JsonObject());
			}
		}else{
			CustomQuestsLogger.warn("'Quest > " + parentQuestId + " > rewards > entries > " + rewardId + " > sub_rewards': Not detected, generating a new JsonObject!");
			subRewards.processJson(new JsonObject());
		}
	}
