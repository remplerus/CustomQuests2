    ...
    public void processJson(JsonObject json){
        ...
        for(Map.Entry<String, JsonElement> jsonEntryElement : json.entrySet()){
            ...
            if(value.isJsonObject()){
                ...
                if(Config.SidedConfig.isDebugModeOn()) CustomQuestsLogger.warn("'Party > " + parentPartyId + " > collective_progress > " + keyInt + "': Value is not a JsonObject, discarding it for now!");
            }
            counter.count();
        }
    }
