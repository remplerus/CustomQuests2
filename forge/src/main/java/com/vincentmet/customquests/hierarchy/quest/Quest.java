	...
	public void processJson(JsonObject json){//todo re-add global, locks, unlocks once start implementing it
		if(json.has("button")){
			...
			if(jsonElement.isJsonObject()){
				...
				CustomQuestsLogger.warn("'Quest > " + questId + " > button': Value is not a JsonObject, generating a new one!");
				button.processJson(new JsonObject());
			}
		}else{
			CustomQuestsLogger.warn("'Quest > " + questId + " > button': Not detected, generating a new JsonObject!");
			button.processJson(new JsonObject());
		}
		...
		if(json.has("title")){
			...
			if(jsonElement.isJsonObject()){
				...
				CustomQuestsLogger.warn("'Quest > " + questId + " > title': Value is not a JsonObject, generating a new one!");
				title.processJson(new JsonObject());
			}
		}else{
			CustomQuestsLogger.warn("'Quest > " + questId + " > title': Not detected, generating a new JsonObject!");
			title.processJson(new JsonObject());
		}
		...
		if(json.has("subtitle")){
			...
			if(jsonElement.isJsonObject()){
				...
				CustomQuestsLogger.warn("'Quest > " + questId + " > subtitle': Value is not a JsonObject, generating a new one!");
				subtitle.processJson(new JsonObject());
			}
		}else{
			CustomQuestsLogger.warn("'Quest > " + questId + " > subtitle': Not detected, generating a new JsonObject!");
			subtitle.processJson(new JsonObject());
		}
		...
		if(json.has("text")){
			...
			if(jsonElement.isJsonObject()){
				...
				CustomQuestsLogger.warn("'Quest > " + questId + " > text': Value is not a JsonObject, generating a new one!");
				text.processJson(new JsonObject());
			}
		}else{
			CustomQuestsLogger.warn("'Quest > " + questId + " > text': Not detected, generating a new JsonObject!");
			text.processJson(new JsonObject());
		}
		...
		if(json.has("dependencies")){
			...
			if(jsonElement.isJsonObject()){
				...
				CustomQuestsLogger.warn("'Quest > " + questId + " > dependencies': Value is not a JsonObject, generating a new one!");
				dependencyList.processJson(new JsonObject());
			}
		}else{
			CustomQuestsLogger.warn("'Quest > " + questId + " > dependencies': Not detected, generating a new JsonObject!");
			dependencyList.processJson(new JsonObject());
		}
		...
		if(json.has("tasks")){
			...
			if(jsonElement.isJsonObject()){
				...
				CustomQuestsLogger.warn("'Quest > " + questId + " > tasks': Value is not a JsonObject, generating a new one!");
				tasks.processJson(new JsonObject());
			}
		}else{
			CustomQuestsLogger.warn("'Quest > " + questId + " > tasks': Not detected, generating a new JsonObject!");
			tasks.processJson(new JsonObject());
		}
		...
		if(json.has("rewards")){
			...
			if(jsonElement.isJsonObject()){
				...
				CustomQuestsLogger.warn("'Quest > " + questId + " > rewards': Value is not a JsonObject, generating a new one!");
				rewards.processJson(new JsonObject());
			}
		}else{
			CustomQuestsLogger.warn("'Quest > " + questId + " > rewards': Not detected, generating a new JsonObject!");
			rewards.processJson(new JsonObject());
		}
		...
		if(json.has("position")){
			...
			if(jsonElement.isJsonObject()){
				...
				CustomQuestsLogger.warn("'Quest > " + questId + " > position': Value is not a JsonObject, generating a new one!");
				position.processJson(new JsonObject());
			}
		}else{
			CustomQuestsLogger.warn("'Quest > " + questId + " > position': Not detected, generating a new JsonObject!");
			position.processJson(new JsonObject());
		}
	}
