			...
			if(jsonElement.isJsonPrimitive()){
				...
				if(jsonPrimitive.isNumber()){
					...
					if(jsonPrimitiveIntValue>=0){
						...
						CustomQuestsLogger.warn("'Quest > " + parentQuestId + " > position > x': Value is not an Integer, please use an Integer which is 0 or higher, defaulting to '0'!");
						setX(0);
					}
				}else{
					CustomQuestsLogger.warn("'Quest > " + parentQuestId + " > position > x': Value is not a Number, please use an Integer which is 0 or higher, defaulting to '0'!");
					setX(0);
				}
			}else{
				CustomQuestsLogger.warn("'Quest > " + parentQuestId + " > position > x': Value is not a Primitive, defaulting to '0'!");
				setX(0);
			}
		}else{
			CustomQuestsLogger.warn("'Quest > " + parentQuestId + " > position > x': Not detected, defaulting to '0'!");
			setX(0);
		}
		if(json.has("y")){
			...
			if(jsonElement.isJsonPrimitive()){
				...
				if(jsonPrimitive.isNumber()){
					...
					if(jsonPrimitiveIntValue>=0){
						...
						CustomQuestsLogger.warn("'Quest > " + parentQuestId + " > position > y': Value is not an Integer, please use an Integer which is 0 or higher, defaulting to '0'!");
						setY(0);
					}
				}else{
					CustomQuestsLogger.warn("'Quest > " + parentQuestId + " > position > y': Value is not a Number, please use an Integer which is 0 or higher, defaulting to '0'!");
					setY(0);
				}
			}else{
				CustomQuestsLogger.warn("'Quest > " + parentQuestId + " > position > y': Value is not a Primitive, defaulting to '0'!");
				setY(0);
			}
		}else{
			CustomQuestsLogger.warn("'Quest > " + parentQuestId + " > position > y': Not detected, defaulting to '0'!");
			setY(0);
		}
	}
