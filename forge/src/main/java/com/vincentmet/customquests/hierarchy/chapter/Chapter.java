	...
	public void processJson(JsonObject json){
		...
		if(json.has("title")){
			...
			if(jsonElement.isJsonObject()){
				...
				CustomQuestsLogger.warn("'Chapter > " + id + " > title': Value is not a JsonObject, generating a new one!");
				title.processJson(new JsonObject());
			}
		}else{
			CustomQuestsLogger.warn("'Chapter > " + id + " > title': Not detected, generating a new JsonObject!");
			title.processJson(new JsonObject());
		}
		...
		if(json.has("text")){
			...
			if(jsonElement.isJsonObject()){
				...
				CustomQuestsLogger.warn("'Chapter > " + id + " > text': Value is not a JsonObject, generating a new one!");
				text.processJson(new JsonObject());
			}
		}else{
			CustomQuestsLogger.warn("'Chapter > " + id + " > text': Not detected, generating a new JsonObject!");
			text.processJson(new JsonObject());
		}
		...
		if(json.has("quests")){
			...
			if(jsonElement.isJsonArray()){
				...
				CustomQuestsLogger.warn("'Chapter > " + id + " > quests': Value is not a JsonArray, generating a new one!");
			}
		}else{
			CustomQuestsLogger.warn("'Chapter > " + id + " > quests': Not detected, generating a new JsonArray!");
		}
	}
