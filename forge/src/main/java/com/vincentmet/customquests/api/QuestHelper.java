...
public class QuestHelper{
	...
	public static void executeAllSubrewards(UUID claimer, int questId, int rewardId){
		QuestingStorage.getSidedQuestsMap().get(questId).getRewards().get(rewardId).getSubRewards().executeAllSubrewards(Constants.currentServerInstance.getPlayerList().getPlayer(claimer));
	}
