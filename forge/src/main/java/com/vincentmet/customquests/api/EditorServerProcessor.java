    ...
    public static class Create {
        ...
        public static void createTask(int questId) {
            if (QuestHelper.doesQuestExist(questId)) {
                ...
                Task t = new Task(questId, newTaskId, new ResourceLocation(Constants.MODID, "item_detect"));//todo check out if it's possible to have a Task constructor without a type parameter!
        ...
        public static void createSubtask(int questId, int taskId) {
            if (QuestHelper.doesTaskExist(questId, taskId)) {
                ...
                SubTask st = new SubTask(questId, taskId, newSubtaskId, new ResourceLocation(Constants.MODID, "item_detect"));//todo check out if it's possible to have a SubTask constructor without a type parameter!
