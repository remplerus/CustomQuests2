...
public class QuestButton implements MovableScalableCanvasEntry{
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks){
		...
		guiGraphics.blit(icon.getResourceLocation(), parentX + x, parentY + y, buttonState.u, buttonState.v, buttonState.WIDTH, buttonState.HEIGHT, 72, 72);
		icon.render(guiGraphics, buttonScale, parentX + x, parentY + y, 0.25f, 0.25f, mouseX, mouseY);
		matrixStack.popPose();
	}
