...
public class QuestSelector extends Screen {
    ...
    public void renderHover(GuiGraphics stack, int mouseX, int mouseY, float partialTicks) {
        enableButton.renderHover(stack, mouseX, mouseY, partialTicks);
        disableButton.renderHover(stack, mouseX, mouseY, partialTicks);
    }

    private void drawBackgrounds(GuiGraphics stack){
        TooltipBuffer.tooltipBuffer.clear();
        stack.fill(0, 0, width, height, 0x88000000);
        stack.fill(FILTER_BOX_X.getAsInt(), FILTER_BOX_Y.getAsInt(), FILTER_BOX_X.getAsInt() + FILTER_BOX_WIDTH.getAsInt(), FILTER_BOX_Y.getAsInt() + FILTER_BOX_HEIGHT.getAsInt(), 0x88000000);
        stack.fill(DISABLED_BOX_X.getAsInt(), DISABLED_BOX_Y.getAsInt(), DISABLED_BOX_X.getAsInt() + DISABLED_BOX_WIDTH.getAsInt(), DISABLED_BOX_Y.getAsInt() + DISABLED_BOX_HEIGHT.getAsInt(), 0x88000000);
        stack.fill(ENABLED_BOX_X.getAsInt(), ENABLED_BOX_Y.getAsInt(), ENABLED_BOX_X.getAsInt() + ENABLED_BOX_WIDTH.getAsInt(), ENABLED_BOX_Y.getAsInt() + ENABLED_BOX_HEIGHT.getAsInt(), 0x88000000);
