...
public class EditorScreen extends Screen {
    ...
    public EditorScreen(){
        super(Component.translatable(Constants.MODID + ".screens.editor"));
    }
    ...
    public void render(GuiGraphics matrixStack, int mouseX, int mouseY, float partialTicks){
        ...
        matrixStack.fill(SELECTION_BUTTONS_X.getAsInt(), SELECTION_BUTTONS_Y.getAsInt(), SELECTION_BUTTONS_X.getAsInt() + SELECTION_BUTTONS_WIDTH.getAsInt(), SELECTION_BUTTONS_Y.getAsInt() + SELECTION_BUTTONS_HEIGHT.getAsInt(), 0x88000000);
        matrixStack.fill(EDITOR_AREA_X.getAsInt(), EDITOR_AREA_Y.getAsInt(), EDITOR_AREA_X.getAsInt() + EDITOR_AREA_WIDTH.getAsInt(), EDITOR_AREA_Y.getAsInt() + EDITOR_AREA_HEIGHT.getAsInt(), 0x88000000);
